...
class ExtractSQLQuery(ExtractBase):
    ...
    Params:
        ...
        kwargs: (dict). Defined in `KwargsExtractSQLQuery` class.
            For more info: https://pandas.pydata.org/docs/reference/api/pandas.read_sql_query.html

    Example:
        >>> import pandas as pd
        >>> from pathlib import Path
        >>> from tiny_blocks.extract import ExtractSQLQuery
        >>> extract_csv = ExtractSQLQuery(dsn_conn="psycopg2+postgres://user:***@localhost:5432/foobar")
